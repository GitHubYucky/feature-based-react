...
1. まず `steering` を使い、`.steering/[YYYYMMDD]-[作業名]/` に今回の相談内容を残す。
2. ユーザーの作りたいものを 1-2 文で言い換える。
3. 足りない観点だけを順番に壁打ちする。
4. 特に次を明確にする。
   - 誰のためのものか
   - 最初に必要な機能は何か
   - 後回しでよい機能は何か
   - 制約や避けたいことは何か
5. 会話を広げすぎず、`initial-requirements.md` に入る粒度まで絞る。
6. 最後に Markdown でそのまま転記できる草案を返す。
