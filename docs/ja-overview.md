...
| ファイル | 内容 |
|---|---|
| `application-overview.md` | データモデル・ユーザーロール・チーム構造 |
| `project-standards.md` | ESLint・Prettier・TypeScript・命名規則 |
| `project-structure.md` | フォルダ構成・フィーチャー分離・依存方向 |
| `state-management.md` | 状態管理の種類と使い分け |
| `api-layer.md` | API クライアント・リクエスト宣言・型安全性 |
| `components-and-styling.md` | コンポーネント設計・Storybook・スタイリング |
| `testing.md` | テスト手法・Vitest・Playwright・MSW |
| `error-handling.md` | API エラー・エラー境界・Sentry 連携 |
| `security.md` | 認証・認可・RBAC・PBAC・XSS 対策 |
| `performance.md` | コード分割・コンポーネント最適化 |
| `deployment.md` | Vercel・Netlify・AWS・CloudFlare へのデプロイ |
| `additional-resources.md` | 学習リソース集 |
