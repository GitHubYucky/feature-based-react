...
| ファイル | 内容 |
|---|---|
| `project/アプリケーション概要.md` | データモデル・ユーザーロール・チーム構造 |
| `project/プロジェクト標準.md` | ESLint・Prettier・TypeScript・命名規則 |
| `project/プロジェクト構造.md` | フォルダ構成・フィーチャー分離・依存方向 |
| `project/状態管理.md` | 状態管理の種類と使い分け |
| `project/APIレイヤー.md` | API クライアント・リクエスト宣言・型安全性 |
| `project/コンポーネントとスタイリング.md` | コンポーネント設計・Storybook・スタイリング |
| `project/テスト.md` | テスト手法・Vitest・Playwright・MSW |
| `project/エラーハンドリング.md` | API エラー・エラー境界・Sentry 連携 |
| `project/セキュリティ.md` | 認証・認可・RBAC・PBAC・XSS 対策 |
| `project/パフォーマンス.md` | コード分割・コンポーネント最適化 |
| `project/デプロイ.md` | Vercel・Netlify・AWS・CloudFlare へのデプロイ |
| `project/追加リソース.md` | 学習リソース集 |
